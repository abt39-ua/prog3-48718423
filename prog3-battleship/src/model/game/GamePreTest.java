...
public class GamePreTest {
	...
	public void testPlayEmptyRebelShip() {
		...
		String inputImp2 = "1/locooo\nexit\n";
		stringReader = new StringReader(inputImp2);
		BufferedReader br2 = new BufferedReader(stringReader);
		plfRebel = new PlayerFile(Side.REBEL, br2);
		...
		assertEquals("ganador imperial", Side.IMPERIAL, winner);
